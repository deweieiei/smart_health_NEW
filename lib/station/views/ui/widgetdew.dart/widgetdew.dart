// ignore_for_file: prefer_typing_uninitialized_variables, camel_case_types, non_constant_identifier_names, use_build_context_synchronously
...
import 'package:smart_health/station/widget_decorate/WidgetDecorate.dart';
  ...
  void start() {
    timer = Timer.periodic(const Duration(seconds: 1), (Timer t) {
      setState(() {
        ...
        data = "${dateTime.hour}:${dateTime.minute.toString().padLeft(2, '0')}:${dateTime.second.toString().padLeft(2, '0')}";
      });
    });
  }
...
class _BoxWidetdewState extends State<BoxWidetdew> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: widget.height == null ? height * 0.02 : height * widget.height,
      width: widget.width == null ? width * 0.08 : width * widget.width,
      child: Center(
        child: widget.text == null
            ...
            : Text(
                ...
                style: TextStyle(
                  fontFamily: context.read<DataProvider>().fontFamily,
                  fontSize:
                      widget.fontSize == null ? 20 : width * widget.fontSize,
      ...
      children: [
        ...
        Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "${widget.dataidcard['personal']['first_name']}" '  ' "${widget.dataidcard['personal']['last_name']}",
                  style: TextStyle(
                    fontFamily: context.read<DataProvider>().fontFamily,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        child: widget.pathicon == null
            ...
            : Image.asset(
                '${widget.pathicon}',
                height: widget.height == null ? 1 : height * widget.height,
                width: widget.width == null ? 1 : width * widget.width,
              ));
  }
}
            ...
            ? SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                          color:const Color.fromARGB(149, 18, 42, 253),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              BoxWidetdew(
                                ...
                                fontSize: 0.025,
                                text: textqueue,
                                textcolor:const Color.fromARGB(255, 43, 179, 161),
                              ),
                            ],
                          ),
                          Column(
...
class BoxShoHealth_Records extends StatefulWidget {
  const BoxShoHealth_Records({super.key});
...
class _BoxShoHealth_RecordsState extends State<BoxShoHealth_Records> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle styletext2 = TextStyle(
        fontFamily: context.read<DataProvider>().fontFamily,
        color: const Color.fromARGB(255, 12, 172, 153),
        fontSize: width * 0.03);
    TextStyle styletext3 = TextStyle(
        fontFamily: context.read<DataProvider>().fontFamily,
        color: const Color.fromARGB(255, 39, 0, 129),
        fontSize: width * 0.04,
        fontWeight: FontWeight.w600);
    TextStyle styletext4 = TextStyle(
        fontFamily: context.read<DataProvider>().fontFamily,
        color: const Color.fromARGB(255, 28, 1, 91),
        fontSize: width * 0.03);
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            color: const Color.fromARGB(255, 95, 182, 167),
            height: height * 0.04,
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                          ...
                          return GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  color: const Color.fromARGB(255, 219, 246, 240),
                                  height: height * 0.05,
                                  child: Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      resTojson['health_records'][index]
                                                  ['updated_at'] ==
                                              null
                                          ? BoxDataHealth(child: const Text(' - '))
                                          : BoxDataHealth(
                                              child: Text(
...
class _BoxRunQueue2State extends State<BoxRunQueue2> {
                  ...
                  return Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: const TextStyle(color: Color(0xff1B6286)),
                      ),
                    ),
                  );
                },
  ...
  Widget build(BuildContext context) {
    ...
    BoxDecoration boxdecoration_box3 = const BoxDecoration(
      borderRadius: BorderRadius.only(
          topRight: Radius.circular(10), topLeft: Radius.circular(10)),
      color: Color(0xff31D6AA),
    );
    BoxDecoration boxdecoration_box4 = const BoxDecoration(
      borderRadius: BorderRadius.only(
          topRight: Radius.circular(10), topLeft: Radius.circular(10)),
...
class _BoxRunQueueState extends State<BoxRunQueue> {
    ...
    return resTojson != null
        ...
        : loadplatfromURL == true
            ...
            children: [
              ...
              const Text('platfromURL ไม่ถูหต้อง')
            ],
                          ))
            : Container();
  }
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle style = TextStyle(
        ...
        fontFamily: context.read<DataProvider>().fontFamily,
        fontWeight: FontWeight.w600,
        color: const Color.fromARGB(255, 0, 98, 82));
    return Container(
          width: width * 0.7,
          decoration: boxDecoration,
          child: Column(
              ...
              ? SizedBox(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: width * 0.6, child: listQ()),
                    ],
                  ))
              : Container()
          : Container(),
              ...
              ? SizedBox(
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                          width: width * 0.1,
                          child: const Text('คิวที่ถูกข้าม')),
                      SizedBox(width: width * 0.6, child: calleds()),
                    ],
                  ))
              : Container()
          : Container()
...
class _HeadBoxAppointmentsState extends State<HeadBoxAppointments> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle style2 = TextStyle(
        fontFamily: context.read<DataProvider>().fontFamily,
        color: const Color.fromARGB(255, 0, 73, 129),
    ...
    return Column(
      children: [
        ...
        Container(
          color: const Color.fromARGB(255, 115, 250, 221),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              SizedBox(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: BoxWidetdew(
          ...
          width: 0.4,
          radius: 20.0,
          color: const Color.fromARGB(80, 91, 223, 95),
          text: 'video call',
          textcolor: Colors.white,
        ),
      ),
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: const Color.fromARGB(255, 0, 85, 71), width: 2),
                    borderRadius: BorderRadius.circular(5)),
                width: _width * 0.9,
                child: TextField(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(15),
                                  border: Border.all(
                                      width: 5, color: const Color(0xff31D6AA))),
                              child: Column(children: [
                                Container(
                                  child: Column(children: [
                                    Text(
...
class _ButtonPrintQueueState extends State<ButtonPrintQueue> {
  ...
  void initState() {
    ...
    setState(() {
      dateTime = DateTime.now();
      datatime = "${dateTime.hour}: " "${dateTime.minute}  ${dateTime.day}/${dateTime.month}/${dateTime.year}";
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ontap == false
        ...
        : Container(
            height: 0.06, width: 0.35, child: const CircularProgressIndicator());
  }
}
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const PrePareVideo()));
                          },
                          child: BoxWidetdew(
                            radius: 2.0,
                            color: Colors.blue,
                        ...
                        child: Center(
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10),
                                  border: Border.all(
                                      color: const Color(0xff76FFD5), width: 8)),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
