...
import 'package:smart_health/myapp/menu/callcenter.dart';
import 'package:smart_health/myapp/menu/data_hospital.dart';
import 'package:smart_health/myapp/menu/internet.dart';
import 'package:smart_health/myapp/menu/map.dart';
import 'package:smart_health/myapp/menu/treatment_rights.dart';
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Stack(
            children: [
              Positioned(
                  child: SvgPicture.asset('assets/backgrund/backgrund-home.svg',
                      fit: BoxFit.fill)),
              Positioned(
                child: ListView(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                            ...
                            child: boxmenu(
                                'assets/image_menu/h-map.jpg', 'แผนที่')),
                        GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
